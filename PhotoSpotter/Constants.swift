...
public class Constants {
    ...
    public static let DOF_FILL            : UIColor = UIColor.init(displayP3Red: 0.45490196, green: 0.80784314, blue: 1.0, alpha: 0.25)
    public static let DOF_STROKE          : UIColor = UIColor.init(displayP3Red: 0.45490196, green: 0.80784314, blue: 1.0, alpha: 1.0)
    public static let MAX_FOV_FILL        : UIColor = UIColor.init(displayP3Red: 0.0, green: 0.56078431, blue: 0.8627451, alpha: 0.15)
    public static let MAX_FOV_STROKE      : UIColor = UIColor.init(displayP3Red: 0.0, green: 0.56078431, blue:  0.8627451, alpha: 1.0)
    public static let MIN_FOV_FILL        : UIColor = UIColor.clear
    public static let MIN_FOV_STROKE      : UIColor = UIColor.init(displayP3Red: 0.0, green: 0.56078431, blue:  0.8627451, alpha: 1.0)
    public static let FOV_FILL            : UIColor = UIColor.init(displayP3Red: 0.0, green: 0.56078431, blue: 0.8627451, alpha: 0.45)
    public static let FOV_STROKE          : UIColor = UIColor.init(displayP3Red: 0.0, green: 0.56078431, blue:  0.8627451, alpha: 1.0)
    public static let FOV_FRAME_FILL      : UIColor = UIColor.clear
    public static let FOV_FRAME_STROKE    : UIColor = UIColor.init(displayP3Red: 0.0, green: 0.56078431, blue:  0.8627451, alpha: 1.0)

    public static let CENTER_LINE_STROKE  : UIColor = UIColor.init(displayP3Red: 0.0, green: 0.56078431, blue:  0.8627451, alpha: 1.0)
    public static let MOON_RISE_STROKE    : UIColor = UIColor.init(displayP3Red: 0.5, green: 0.5, blue:  0.5, alpha: 1.0)
    public static let MOON_SET_STROKE     : UIColor = UIColor.init(displayP3Red: 0.25, green: 0.25, blue:  0.25, alpha: 1.0)
